...
public class Cognito {
    ...
    private final String poolID = "us-east-1_5O6LODWtl";
    private final String clientID = "vvoocfn86gihq3r5s9r2pfvpt";
    private final String clientSecret = "1iba09bl7crjg9s2fhjeqsb7oclna0m5mo79ftfght0hmpdcolts";
    private final Regions awsRegion = Regions.US_EAST_1;         // Place your Region
    ...
    AuthenticationHandler authenticationHandler = new AuthenticationHandler() {
        ...
        public void onSuccess(CognitoUserSession userSession, CognitoDevice newDevice) {
            ...
            Intent intent = new Intent(appContext, hilfe_finden.class);
